...
export const ru: SeoStrings = {
  ...
  home: () => ({
    title: `Словарь сленга – значения, примеры и сленг по странам`,
    description: truncate(
      'Откройте для себя сленговые слова и фразы со всего мира. Значения, примеры, произношение, происхождение и сленг по странам в нашем онлайн-словаре сленга.',
    ),
  }),
