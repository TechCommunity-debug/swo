...
export const ru: Strings = {
  ...
  editorialH2: 'Каждая статья написана, а не сгенерирована',
  editorialBody:
  ...
  howWeSource: 'Как мы составляем определения',
  ...
  reviewedBy: (who: string) => `Проверка: ${who}.`,
  ...
  footerNote:
    'Определения пишут и проверяют люди. Где происхождение спорно, мы так и пишем.',
